...
// Admin Dashboard Component to render Analytical graph data
const AdminDashboard = () => {

  // Store data for dashboard and employee charts
  ...
  useEffect(() => {
    if (date) {
      fetchEmployeeData(date)
        .then((data) => setEmployeeData(data))
        .catch((err) => console.error(err));
    }
  }, [date]);

  // Handle date change for employee
  ...
  return (
    <div>
      ...
      <input
        ...
        type="date"
        value={date}
        onChange={(e) => handleEmployeeProduction(e.target.value)}
      />
